...
const projectsBackup = [
  ...
  {
    name: "notes",
    description: "Personal notes for Vim, tmux, GNU Bash, zsh, Linux, Programming...",
  ...
  },
  {
    ...
    description: "Comprehensive GNU Readline Shortcuts Guide for VI + Emacs Editing Modes.",
  ...
  },
  {
    ...
    description: "Firefox add-on to view total duration of playlists on Invidio.us.",
    homepage: "https://addons.mozilla.org/en-US/firefox/addon/invidious-playlist-duration/",
    stargazers_count: 0,
    forks_count: 0
  },
]
    ...
    <Layout>
      ...
      <ul>
        {projectsBackup.map((project, idx) => (
          <li key={idx}><GitHubProjectData project={project} /></li>
        ))}
      </ul>
    </Layout>
  )
